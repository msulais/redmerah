...
const Menu: ParentComponent<MenuProps> = ($props) => {
	const [props, other] = splitProps($props, [_classList, _gap, _padding, _inputAutoFocus])
	return (<Modal
		classList={{
			'c-menu': true,
			...props[_classList]
		}}
		inputAutoFocus={props[_inputAutoFocus] ?? true}
		gap={props[_gap] ?? 8}
