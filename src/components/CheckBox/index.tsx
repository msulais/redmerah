...
const CheckBox: ParentComponent<CheckBoxProps> = ($props) => {
    ...
    createEffect(() => {
        if (!isInitialize && props[_value] && props[_value] != isSelected() && props[_onValueChanged]){
    ...
    return (<div data-selected={toggleAttribute(isSelected())} data-disabled={toggleAttribute(props[_disabled])} class="checkbox" {...other} onClick={() => changeValue()}>
