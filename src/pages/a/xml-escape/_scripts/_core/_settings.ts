...
import { EscaperStore } from "./_escaper"
...
const _ref_input = $(ElementIds.bd_unescape) as HTMLTextAreaElement
const _ref_output = $(ElementIds.bd_escape) as HTMLTextAreaElement
