...
function _initSubscriber(): void {
	sg_textWrap.subscribe(v => {
		_ref_inputMarkdown.toggleAttribute('data-text-wrap', v)
		_ref_inputCSS     .toggleAttribute('data-text-wrap', v)
		_ref_outputHTML   .toggleAttribute('data-text-wrap', v)
...
function _initEvents(): void {
	...
	delegateEvent(_ref_sett_textWrap, 'change', () => {
		sg_textWrap.set(_ref_sett_textWrap.checked)
	})
}
