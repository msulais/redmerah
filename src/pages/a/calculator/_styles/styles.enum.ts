...
export const PageProgrammerBtnValue = 'pbv'
export const PageProgrammerBtnHex = 'phex'
export const PageProgrammerBtnDec = 'pdec'
export const PageProgrammerBtnOct = 'poct'
export const PageProgrammerBtnBin = 'pbin'