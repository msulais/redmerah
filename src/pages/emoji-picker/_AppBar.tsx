...
const _: VoidComponent = () => {
	...
	const Menus: VoidComponent = () => {
		return (<>
			<Menu
				...
				<MenuItem
					onClick={() => {
						getNavigator()[_share]({ title: 'Emoji Picker', text: 'Emoji Picker', url: getDocument()[_URL] })
				...
				<LinkMenuItem
					onClick={() => closeMenu(menu_info_ref)}
					href={'mailto:' + ExternalLinks[_contactEmail] + '?subject=' + encodeURL('Emoji Picker')}
					iconCode={0xE3A0}>
					Send feedback
				</LinkMenuItem>
				<LinkMenuItem
	...
	return (<>
		<AppBar
			leading={<img alt="Emoji Picker logo" width={32} src={logo[_src]} />}
