...
export class ElementIds {
	...
	static readonly apMore_copyUnescape = _createId()
	static readonly apMore_copyEscape = _createId()

	// bd = body
	static readonly bd_inputContainer = _createId()
	static readonly bd_unescape = _createId()
	static readonly bd_escape = _createId()
