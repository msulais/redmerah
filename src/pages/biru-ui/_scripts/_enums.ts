...
export class ElementIds {
	...
	static readonly panelComboBox = _createId()
	static readonly panelComboBoxPreview = _createId()
	static readonly panelComboBoxOptions = _createId()
	static readonly panelComboBoxOptionsVariant = _createId()
