...
const _markdownRef = $(ElementIds.bd_markdown) as HTMLTextAreaElement
const _htmlRef = $(ElementIds.bd_html) as HTMLTextAreaElement
...
function _subsTextWrapView(v: SettingsStoreType, o: SettingsStoreType): void {
	...
	_markdownRef.toggleAttribute('data-text-wrap', textWrap)
	_htmlRef.toggleAttribute('data-text-wrap', textWrap)
